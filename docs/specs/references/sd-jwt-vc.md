...
**Status:** Internet Draft (draft-ietf-oauth-sd-jwt-vc-15, Feb 2026)
**URL:** https://datatracker.ietf.org/doc/draft-ietf-oauth-sd-jwt-vc/
**HTML:** https://www.ietf.org/archive/id/draft-ietf-oauth-sd-jwt-vc-15.html
...
| `iss` | OPTIONAL (since draft-14) | Was REQUIRED in draft-08. Can use x5c instead |
